...
for i in range(nb_cap) :
    liste_etude_cap.append(int(input("Quel capteur souhaitez vous étudier ? (Entre 1 et 6, un différent à chaque fois) Le capteur : ")))
bol_intervalle = input("Voulez vous étudier cela sur un intervalle donné ? (Oui ou Non) : ")
if bol_intervalle == 'Oui' :
...
with open("EIVP_KM(2).csv","r") as mesures : # Ouverture du fichier csv
