...
def occupation(L,cap):
    ...
    for i in range(len(date_occupation[cap])-1) :
        # print('boucle1')
        if (i > 0 and liste_cap[cap][3][2][i-1] == 0 and liste_cap[cap][3][2][i] > 0)  or (i == 0 and liste_cap[cap][3][2][i] > 0 and liste_cap[cap][3][2][i+1] > 0):
            # print('yes')
            intervalle_occupation.append([])
            intervalle_occupation[count_int].append(date_occupation[cap][i])
            count_int += 1
        elif i > 0 and liste_cap[cap][3][2][i-1] > 0 and liste_cap[cap][3][2][i] == 0 :
            # print('no')
            print('i : ', i)
